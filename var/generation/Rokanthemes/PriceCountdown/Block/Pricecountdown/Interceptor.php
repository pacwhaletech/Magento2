...
class Interceptor extends \Rokanthemes\PriceCountdown\Block\Pricecountdown implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Catalog\Api\CategoryRepositoryInterface $categoryRepository, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Catalog\Model\Config $catalogConfig, \Magento\Catalog\Model\Product\Visibility $productVisibility, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $postDataHelper, $layerResolver, $categoryRepository, $urlHelper, $productCollectionFactory, $storeManager, $catalogConfig, $productVisibility, $data);
    }
    ...
    public function cut_string_featuredproduct($string, $number)
    {
        ...
        if (!$pluginInfo) {
            return parent::cut_string_featuredproduct($string, $number);
        } else {
            return $this->___callPlugins('cut_string_featuredproduct', func_get_args(), $pluginInfo);
        }
    }
